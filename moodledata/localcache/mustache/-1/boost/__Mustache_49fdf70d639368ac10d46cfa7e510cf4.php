...
class __Mustache_49fdf70d639368ac10d46cfa7e510cf4 extends Mustache_Template
{
...
';
        // 'output.should_display_navbar_logo' section
        $value = $context->findDot('output.should_display_navbar_logo');
        $buffer .= $this->section3a0f4d747d083f7ee1435142d0e76bb3($context, $indent, $value);
...
';
    ...
    private function section3a0f4d747d083f7ee1435142d0e76bb3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
