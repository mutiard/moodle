...
class __Mustache_5effce60d4d13d97765c476b6d9643f0 extends Mustache_Template
{
...
';
        ...
        $value = $context->findDot('element.staticlabel');
        $buffer .= $this->section12970408fa03ae7bcf1e61cc02a1cf19($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section12970408fa03ae7bcf1e61cc02a1cf19(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
