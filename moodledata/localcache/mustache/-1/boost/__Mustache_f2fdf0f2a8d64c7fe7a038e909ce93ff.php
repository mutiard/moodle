...
class __Mustache_f2fdf0f2a8d64c7fe7a038e909ce93ff extends Mustache_Template
{
...
';
        ...
        $blocksContext['courseid'] = array($this, 'blockCee4dfcf1c95f38f777a281c0fdbc7c9');
...
';
    ...
    public function blockCee4dfcf1c95f38f777a281c0fdbc7c9($context)
    {
        $indent = $buffer = '';
        $blocksContext = array();
        $value = $this->resolveValue($context->find('id'), $context);
