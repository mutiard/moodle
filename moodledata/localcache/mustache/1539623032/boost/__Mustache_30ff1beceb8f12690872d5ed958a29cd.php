...
class __Mustache_30ff1beceb8f12690872d5ed958a29cd extends Mustache_Template
{
...
';
        // 'error' section
        $value = $context->find('error');
        $buffer .= $this->section55b699a64a8389b7514d133f0a3a422b($context, $indent, $value);
        // 'element.frozen' section
        $value = $context->findDot('element.frozen');
...
';
    ...
    private function section55b699a64a8389b7514d133f0a3a422b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
