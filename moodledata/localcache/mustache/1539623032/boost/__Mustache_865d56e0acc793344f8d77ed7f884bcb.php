...
class __Mustache_865d56e0acc793344f8d77ed7f884bcb extends Mustache_Template
{
...
';
            ...
            $value = $context->findDot('element.frozen');
            $buffer .= $this->sectionAa867ad5118b07e1842b109b89bd9685($context, $indent, $value);
        }
...
';
        ...
        $buffer .= $this->sectionEa3427001a5d4d6fa3d0ec4df9cf6444($context, $indent, $value);
        $buffer .= $indent . '            id="';
...
';
        ...
        // 'element.frozen' section
        $value = $context->findDot('element.frozen');
        $buffer .= $this->sectionCd30c2c1f2c77af04214a1275984e477($context, $indent, $value);
        $buffer .= $indent . '            ';
...
';
        // 'text' section
        $value = $context->find('text');
        $buffer .= $this->sectionB718fcc4d16259dc4668f977f6de8bcb($context, $indent, $value);
...
';
    ...
    private function sectionAa867ad5118b07e1842b109b89bd9685(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
    ...
    private function sectionEa3427001a5d4d6fa3d0ec4df9cf6444(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
    ...
    private function sectionCd30c2c1f2c77af04214a1275984e477(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
    ...
    private function sectionB718fcc4d16259dc4668f977f6de8bcb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
