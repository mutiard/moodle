...
class __Mustache_ce876af993342ae2ea88a4441949e500 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $blocksContext['element'] = array($this, 'block8a28cf791f8c5cd201950cf77d226610');
    ...
    private function section731a374dfe1c0fe8291d2cc6c2f6fd7b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
    ...
    public function block8a28cf791f8c5cd201950cf77d226610($context)
    {
        $indent = $buffer = '';
        $blocksContext = array();
...
';
            // 'error' section
            $value = $context->find('error');
            $buffer .= $this->section731a374dfe1c0fe8291d2cc6c2f6fd7b($context, $indent, $value);
            $buffer .= $indent . '        ';
