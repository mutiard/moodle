...
class __Mustache_81b680b4aada22b199bbbf2658e22a08 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section61495ecff926cd8b6f718d80b85a2f34($context, $indent, $value);
        $buffer .= $indent . '</div>
';
    ...
    private function section6457a37895c415628f0a50652e0710e0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
    ...
    private function section61495ecff926cd8b6f718d80b85a2f34(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
                ...
                $buffer .= $this->section6457a37895c415628f0a50652e0710e0($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '        </div>
';
