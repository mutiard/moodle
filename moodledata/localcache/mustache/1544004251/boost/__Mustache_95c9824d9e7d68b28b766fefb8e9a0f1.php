...
class __Mustache_95c9824d9e7d68b28b766fefb8e9a0f1 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section969be5bbe89a00a7bb782cab567726a0($context, $indent, $value);
...
';
        // 'hasblocks' section
        $value = $context->find('hasblocks');
        $buffer .= $this->section8a4e99ccf76f172a4db326409fd2c9e4($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
        ...
        $buffer .= $this->sectionF25522c3b7f2c14d9f2cc90e30c8e2ea($context, $indent, $value);
        $buffer .= $indent . '        </nav>
';
        $buffer .= $indent . '        ';
...
';
    ...
    private function section969be5bbe89a00a7bb782cab567726a0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
    ...
    private function section8a4e99ccf76f172a4db326409fd2c9e4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
    ...
    private function sectionF25522c3b7f2c14d9f2cc90e30c8e2ea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
