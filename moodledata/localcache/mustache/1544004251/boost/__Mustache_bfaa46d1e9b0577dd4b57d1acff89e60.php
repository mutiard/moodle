...
class __Mustache_bfaa46d1e9b0577dd4b57d1acff89e60 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $blocksContext['togglecontent'] = array($this, 'block4e5c4660f17676e23fbeaf9c0d6e80ad');
        ...
        $blocksContext['headeractions'] = array($this, 'block261b5f93d8e139955f98a4d020e793a2');
        $blocksContext['content'] = array($this, 'block113e7897c392e6ec282ac3d632dc13fe');
...
';
    ...
    public function block4e5c4660f17676e23fbeaf9c0d6e80ad($context)
    {
        $indent = $buffer = '';
        $blocksContext = array();
        $buffer .= '        ';
...
';
    ...
    public function block261b5f93d8e139955f98a4d020e793a2($context)
    {
        $indent = $buffer = '';
        $blocksContext = array();
