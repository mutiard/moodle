...
foreach ($courses as $value) {
	$link = '/report/myreport/detail_student.php?studentid='.$value->userid;
	$nilai_aktif = 'A';
	$nilai_autentik = 'A';
	...
	$nilai_intensional = 'B';
	$total = '98.2 %';
	$newtable->data[] = array($key+1, '<a href="'.$link.'">'.$value->firstname.'</a>', $nilai_aktif, $nilai_autentik, $nilai_konstruktif, $nilai_koperatif, $nilai_intensional, $total);
	$key++;
}
